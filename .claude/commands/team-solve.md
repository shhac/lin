---
description: Investigate and solve problems using a team of specialists
...
- Problem description, file path, or list of problems to solve
...
1. Parse `$ARGUMENTS` to identify distinct problems or themes
